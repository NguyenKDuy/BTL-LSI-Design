...
synth_design -top risc_8b -part xc7z020clg400-2
...
write_checkpoint -force -noxdef risc_8b.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file risc_8b_utilization_synth.rpt -pb risc_8b_utilization_synth.pb"  } 
